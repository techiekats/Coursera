...
public class Heap {
	...
	// -------------------------------------------------------------
	   public Heap(int mx, boolean type)            // constructor
	      ...
	      maxSize = mx;
	      currentSize = 0;
	      heapArray = new Integer[maxSize];  // create array
	      isMaxHeap = type;
	      }
	// -------------------------------------------------------------
	...
	// -------------------------------------------------------------
	   public boolean insert(int key)
	      ...
	      if(currentSize==maxSize)
	         return false;
	      Integer newNode = new Integer(key);
	...
	// -------------------------------------------------------------
	   public Integer remove()           // delete item with max key
	...
	// -------------------------------------------------------------
	   public void trickleDown(int index)
	      {
	      int largerChild;
	      Integer top = heapArray[index];       // save root
